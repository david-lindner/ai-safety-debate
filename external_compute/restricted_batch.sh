...
srun -o ~/ai-safety-debate/out_from_experiments/restricted_$SLURM_ARRAY_TASK_ID.out \
     -e ~/ai-safety-debate/out_from_experiments/restricted_$SLURM_ARRAY_TASK_ID.err \

...
class DebatePlayers:
    ...
    def print_debate_result(self, utility, true_label):
        ...
        if self.index_of_our_agent:
            ...
            print(
                'True answer: {}, P1 answer: {}, P2 answer {}, Winner: {}, "Our" utility: {}'.format(
                    true_label,
                    self.agents[0].precommit_label,
                    self.agents[1].precommit_label,
                    winner,
                    truth_utility,
                )
            )
            ...
            print(
                "True label: {}, P1 answer: {}, P2 answer {}, Winner: {}, P1 utility: {}".format(
                    true_label,
                    self.agents[0].precommit_label,
                    self.agents[1].precommit_label,
                    winner,
